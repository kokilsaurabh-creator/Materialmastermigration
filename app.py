...
def render_configuration_dashboard():
    ...
    sap_views = {
        ...
        "15. Valuation Data (S_MBEW)": {
            ...
            "Valuation Category": False, "Valuation Class for Project Stock": False,
            "Commercial Price 1": False, "Commercial Price 2": False, "Commercial Price 3": False,
            "Tax Price 1": False, "Tax Price 2": False, "Tax Price 3": False,
            "LIFO/FIFO-Relevant": False, "Future Planned Price 1": False,
            "Future Planned Price 2": False, "Future Planned Price 3": False
        }
    }
    ...
    # --- UPLOAD & DOWNLOAD XML MODULE ---
        ...
        base_columns = [
            ...
            "Product Group", "Plant", "Sales Organization", "Distribution Channel"
        ]
